...
class Setting extends MY_Controller
{
	...
	public function index()
	{
		...
		$data['users'] = $this->a_model->get_by_Users($data['nis']);

		$this->load->view('private/siswa/setting', $data);
	}
	...
	public function changes()
	{
		...
		$validations = [
			['field' => 'id_user', 'label' => 'ID User', 'rules' => 'required|trim'],
			['field' => 'account', 'label' => 'Account Name', 'rules' => 'required|trim'],
			['field' => 'username', 'label' => 'Username', 'rules' => 'required|trim'],
			['field' => 'password', 'label' => 'Password', 'rules' => 'required|md5'],
		];
